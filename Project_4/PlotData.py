...
#example filename: Ising4e_nSpin_#a_nTemp_#b_MC_#c_ordered.txt, a = number of spins, b = number of temps, c = number of MCs
plt.figure()
...
for file in xrange(len(filenames)):
    ...
    if 100000 >= NumberOfMC > 10000:
        ...
        steps = 1
        NumberOfSteps = 900
    NumberOfSteps = 1000    #(or just plug in NumberOfSteps if known size)
...
plt.savefig('Plots/Plots_c/Temp_mag_20by20')
plt.show()
